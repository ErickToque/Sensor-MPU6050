...
OUTPUT_DIR = r"E:\PUCP\Biomecatronica\Sensor_MPU6050\Datos_MPU6050" #ACTUALICE
...
print("Presiona '1', '2' o '3' para cambiar de clase. Presiona 'ESPACIO' para terminar.") #IMPORTANTE PARA ETIQUETADO
